...
@TeleOp(name = "TestingMecanum", group = "")
public class TestingMecanum extends LinearOpMode{
    //Driver();
    ...
    private void move() {
        ...
        setAPower = gamepad1.left_stick_y - gamepad1.left_stick_x;
        setBPower = gamepad1.left_stick_x + gamepad1.left_stick_y;
